...
MenuView::MenuView() {
  ...
  this->animaMenu->getSprite().setScale({1280/960.0f, 720/540.0f});
  initMusic();

  if (!targetTexture.resize({1280u,720u})) {
  ...
  buttons[0].emplace(buttonTextures[0]);
  buttons[1].emplace(buttonTextures[1]);
  buttons[2].emplace(buttonTextures[2]);
